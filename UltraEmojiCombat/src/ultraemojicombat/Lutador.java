...
public class Lutador {
    ...
    private int vitorias, derotas , empates;

    Lutador(String pettri_Boy, String frança, int i, float f, float f0, String leve, int i0, int i1, int i2) {
    }
          
    // metodos publicos
    public void apresentar(){
        System.out.println("------------------------------------------");
        System.out.println("Chegou hora de apresentar o lutador " + this.getNome());
    ...
    public void status(){
        ...
        System.out.println("Pedeu "+ this.getDerotas()+ " vezes");
    ...
    public Lutador(String nome, String nascionalidade, int idade, float altura, float peso, int vitorias, int derotas, int empates) {
        this.nome = nome;
